...
- C:\workspace\claude\chronicle\CLAUDE.md
- C:\workspace\claude\chronicle\docs\PRD.md
- C:\workspace\claude\chronicle\docs\use-cases.md
...
You are starting the first implementation session for **chronicle**.
