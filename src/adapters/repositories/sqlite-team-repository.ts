...
import type { TeamRepository, SharedCacheEntry } from '../../ports/repositories/team-repository.js';
...
/** A team-shared memory mirrored into the local cache. */
// ── Mappers ───────────────────────────────────────────────────────────────

function rowToSharedCache(row: SharedCacheRow): SharedCacheEntry {
  return {
